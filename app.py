...
app = Flask(__name__)
app.config['SECRET_KEY'] = 'Rz46NsamfMAJH8U1HU3UHxC2UnlAyZLHdoUJ748iSnt'
app.config['SQLALCHEMY_DATABASE_URI'] =  f'sqlite:///{os.path.join(BASE_DIR, "instance", "library.db")}'
